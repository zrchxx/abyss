...
function M.set_colors()
    ...
    AlphaFooter = { fg = p.fg_alt, bg = p.bg },
		...
		NvimTreeEmptyFolderName = { fg = p.fg_alt, bg = p.bg},
		NvimTreeEndOfBuffer = { fg = p.fg, bg = p.bg },
		NvimTreeEndOfBufferNC = { fg = p.fg, bg = p.bg },
		NvimTreeFolderIcon = { fg = p.fg, bg = p.bg },
		NvimTreeFolderName = { fg = p.fg, bg = p.bg},
		NvimTreeGitDeleted = { fg = p.red, bg = p.bg},
		NvimTreeGitDirty = { fg = p.red, bg = p.bg},
		NvimTreeGitNew = { fg = p.blue, bg = p.bg},
		NvimTreeImageFile = { fg = p.fg_alt, bg = p.bg},
		NvimTreeIndentMarker = { fg = p.cyan, bg = p.bg},
		NvimTreeNormal = { fg = p.fg, bg = p.bg },
		NvimTreeNormalNC = { fg = p.fg, bg = p.bg },
		NvimTreeOpenedFolderName = { fg = p.cyan, bg = p.bg},
		NvimTreeRootFolder = { fg = p.fg_alt, bg = p.bg},
		NvimTreeSpecialFile = { fg = p.red, bg = p.bg},
		NvimTreeStatusLineNC = { bg = p.bg, fg = p.bg },
		NvimTreeSymlink = { fg = p.blue, bg = p.bg},
